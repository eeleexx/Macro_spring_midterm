...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale=1.0]
        ...
        \draw[thick,blue] (0,5) -- (5,0) node[below right] {$\text{IS}_1$};
        \node[left] at (0,5) {$(0,5)$};
        \node[below] at (5,0) {$(5,0)$};
        \draw[thick,purple] (0,2.5) -- (5,0) node[below right] {$\text{IS}_2$};
        ...
        \node[above right] at (1.5,1.75) {$E_2$};
    \end{tikzpicture}
